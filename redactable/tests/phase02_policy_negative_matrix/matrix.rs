...
const EXPECTED_POSITIVE_SOURCE_FINGERPRINT: u64 = 0x6389_8ac6_2e65_58a4;
...
#[derive(Clone, Sensitive, serde::Serialize)]
struct WrappedNestedIp { #[serde(skip)] value: std::collections::HashMap<String, Result<safe::SensitiveValue<std::net::IpAddr, safe::IpAddress>, safe::NotSensitiveValue<String>>> }
fn main() {
